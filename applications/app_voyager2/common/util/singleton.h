...
#ifndef VOYAGER_COMMON_UTIL_SINGLETON_H_
#define VOYAGER_COMMON_UTIL_SINGLETON_H_
...
#include "common/util/singleton_impl.h"

#endif  // VOYAGER_COMMON_UTIL_SINGLETON_H_
